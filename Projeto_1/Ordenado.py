...
dicionario = {"tempo_heap":[],"nlogn":[],"tempo_bubble":[],"quantidade_elementos":[]}
...
for i in range(0,quantidade_divisao,1):
    ...
    # vetor_nlogn.append(len(vetor)*np.log(len(vetor))) 
...
plt.ylim(0,np.max(tempo_maximo))
# print(dicionario)
...
# plt.plot(dicionario["quantidade_elementos"],vetor_nlogn,label="n log n")
plt.grid()
